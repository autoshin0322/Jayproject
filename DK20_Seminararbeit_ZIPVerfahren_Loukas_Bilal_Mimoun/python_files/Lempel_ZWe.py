...
class Main(Tk):
    ...
    def __init__(self, parent):
        ...
        self.lbl_encoded_fld = Text(self.frame_encoded_msg, state='disabled', width=64, height=7)
        ...
        self.frame_dictionary_msg = Frame(self.outputs)
        self.frame_dictionary_msg.grid(row=1, column=0, pady=(0, 20))

        self.lbl_dictionary_txt = Label(self.frame_dictionary_msg, text='DECODED MSG', relief='flat')
        self.lbl_dictionary_fld = Text(self.frame_dictionary_msg, state='disabled', width=64, height=7)
        self.scroll_bar_dictionary = Scrollbar(self.frame_dictionary_msg, command=self.lbl_decoded_fld.yview,
                                           orient=VERTICAL)
        self.lbl_decoded_fld['yscrollcommand'] = self.scroll_bar_decode.set
        self.lbl_decoded_fld.see(END)

        self.lbl_dictionary_txt.grid(row=0, column=0)
        self.lbl_dictionary_fld.grid(row=1, column=0)
        self.scroll_bar_dictionary.grid(row=1, column=1, sticky='ns')
        ...
        self.lbl_decoded_fld = Text(self.frame_decoded_msg, state='disabled', width=64, height=7)
