...
def load_model(model_name, device=None):
    ...
    if model_name == "vllm/microsoft/Phi-4-multimodal-instruct":
        ...
        model = VllmQwen2_5VL(logging_level=settings.mm_log_level, model_name="Qwen/Qwen2.5-VL-7B-Instruct")

    elif model_name == "vllm/Qwen/Qwen2.5-VL-3B-Instruct":
            model = VllmQwen2_5VL(logging_level=settings.mm_log_level, model_name="Qwen/Qwen2.5-VL-3B-Instruct")
    elif model_name == "vllm/Qwen/Qwen2.5-VL-32B-Instruct":
            model = VllmQwen2_5VL(logging_level=settings.mm_log_level, model_name="Qwen/Qwen2.5-VL-32B-Instruct")
    elif model_name == "vllm/Qwen/Qwen2.5-VL-72B-Instruct":
            model = VllmQwen2_5VL(logging_level=settings.mm_log_level, model_name="Qwen/Qwen2.5-VL-72B-Instruct")
