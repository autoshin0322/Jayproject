...
# append = 리스트 혹은 튜플 형태로 입력. 1줄 씩 데이터 넣기
...
for row in ws.iter_rows(min_row=2, max_row=11, min_col=2, max_col=3): # 전체 row, column 최소 값부터 최대 값까지 출력 "columns 는 세로 값으로 가져오기, rows 는 가로 값으로 가져오기"
